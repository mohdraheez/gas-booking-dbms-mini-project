...
public class staffactivity extends javax.swing.JFrame {
    String user;
    /**
     * Creates new form staffactivity
     */
    public staffactivity() {
        initComponents();
    }
    
    public staffactivity(String User) {
        user = User;
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        deleteStaff d= new deleteStaff(user);
        d.setVisible(true);
        dispose();
    }//GEN-LAST:event_jButton1ActionPerformed

    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        viewStaff v = new viewStaff(user);
        v.setVisible(true);
        dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(staffactivity.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
