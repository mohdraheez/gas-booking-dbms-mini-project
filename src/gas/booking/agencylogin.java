 ...
 * @author Raheez
 */
public class agencylogin extends javax.swing.JFrame {
Connection connection = null;
    PreparedStatement prp = null;
    ResultSet result = null;
    /**
     * Creates new form agencylogin
     */
    public agencylogin() {
        initComponents();
    }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        String sql ="select password from agency where ag_id ='"+user+"'";
        ...
        try{
            ...
            if(pass.equals(result.getString("password"))){
               ...
               agencyhome a = new agencyhome(user);
            a.setVisible(true);
            dispose();
            }else{
    ...
    private void jLabel4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel4MouseClicked
        agencyRegistration a = new agencyRegistration();
        a.setVisible(true);
        dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(agencylogin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new agencylogin().setVisible(true);
            }
        });
    }
