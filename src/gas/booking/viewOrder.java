...
public class viewOrder extends javax.swing.JFrame {
    ...
    public viewOrder() {
     ...
     public viewOrder(String User) {
         user= User;
        initComponents();
         Object columns[] = {"order ID", "Ordered On", "Agency ID","Amount"};
    ...
    connection = Connector.ConnectDb();
        ...
        String sql = "select ord_id from user where us_id='"+user+"'";
        ...
        try{
            ...
            String sql1= "select ord_id,ordered_on,ag_id,ord_amount from orders where ord_id ='"+rs.getString("ord_id")+"'";
            ...
            while (rs.next()) {
                ...
                columnData[0] = rs.getString("ord_id");
                columnData[1] = rs.getString("ordered_on");
                columnData[2] = rs.getString("ag_id");
                columnData[3] = rs.getString("ord_amount");
