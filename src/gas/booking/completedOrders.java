...
public class completedOrders extends javax.swing.JFrame {
    ...
    public completedOrders(String User) {
        user = User;
        initComponents();
         Object columns[] = {"order ID", "Ordered On", "Agency ID"};
    ...
    connection = Connector.ConnectDb();
        ...
        try{
            ...
            String sql1= "select st_id,ord_id,date_of_delivery from delivery";
            ...
            while (rs.next()) {
                ...
                columnData[1] = rs.getString("ord_id");
                columnData[2] = rs.getString("date_of_delivery");
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Completed Orders");
