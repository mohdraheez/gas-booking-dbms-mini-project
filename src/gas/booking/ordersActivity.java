 ...
 * @author Raheez
 */
public class ordersActivity extends javax.swing.JFrame {
    String user;
    /**
     * Creates new form ordersActivity
     */
    public ordersActivity() {
        initComponents();
    }
    
    public ordersActivity(String User) {
        user = User;
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jButton1.setText("Completed Orders");
        ...
        jButton3.setText("Deliver Order");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        pendingOrders p = new pendingOrders(user);
        p.setVisible(true);
        dispose();
    }//GEN-LAST:event_jButton2ActionPerformed

    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        agencyhome ah = new agencyhome(user);
        ah.setVisible(true);
        dispose();
    }//GEN-LAST:event_jButton4ActionPerformed

    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        deliverOrders d = new deliverOrders(user);
        d.setVisible(true);
        dispose();
    }//GEN-LAST:event_jButton3ActionPerformed

    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        completedOrders c =new completedOrders(user);
        c.setVisible(true);
        dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ordersActivity.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ordersActivity().setVisible(true);
            }
        });
    }
