...
Connection connection = null;
    ...
    /**
     * Creates new form CustomerLogib
     */
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
                ...
                String sql ="select us_password from user where us_id ='"+user+"'";
                ...
                try{
                        ...
                        result.next();
                        if(pass.equals(result.getString("us_password"))){
                                JOptionPane.showMessageDialog(null,"Login Successfull");
                                customerActivity c =  new customerActivity(user);
                                c.setVisible(true);
                                dispose();
                            }else{
